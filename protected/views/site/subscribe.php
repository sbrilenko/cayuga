...
<div id="wrapper">
    <form style="margin: 0 0 18px;" action='https://crm.zoho.com/crm/Unsubscribe?encoding=UTF-8' method='POST'>
        ...
        <table width='481' style='border:10px solid #f4f4f4;margin: 0 auto;' cellpadding='0' cellspacing='0'>
            <tr>
                <td style='padding:10px 0px 10px 10px; font-family:Arial, Helvetica, sans-serif; font-size:13px;color: #333;'>
                    <strong>Enter Your Email Id</strong>
                </td>
                <td style='padding:10px 0px 10px 10px;'>
                    <input type='text' name='email' maxlength='120' style='border-radius: 3px;margin:0;width:190px;border:1px solid #c4d6e2; background-color:#fbfdff; font-family:Arial, Helvetica, sans-serif; font-size:13px;'/>
                </td>
